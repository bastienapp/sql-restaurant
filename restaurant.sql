...
CREATE TABLE `meal` (
  ...
  PRIMARY KEY (`id`),
  KEY `meal_restaurant_FK` (`id_restaurant`),
  CONSTRAINT `meal_restaurant_FK` FOREIGN KEY (`id_restaurant`) REFERENCES `restaurant` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `meal` VALUES (1,'Le menu cher',1),(2,'Le menu très cher',1),(3,'Le menu trop cher',1),(4,'Le menu unique',2),(5,'Pastèque et Camember',3),(6,'Picouli',3),(7,'Menu midi',4),(8,'Menu soir',4),(9,'Brunch de ouf',5),(10,'Les petits plats',6),(11,'Menu enfant',6),(12,'Menu A',7),(13,'Menu B',7),(14,'Menu C',7),(15,'Menu S+',7),(16,'Mangeons bien',8),(17,'Mangeons équilibré',8),(18,'Mangeons peu',8),(19,'Mangeons beaucoup',8),(20,'Faim de table',10);
/*!40000 ALTER TABLE `meal` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `meal_dish`
--
...
CREATE TABLE `meal_dish` (
  ...
  PRIMARY KEY (`id_dish`,`id_meal`),
  KEY `meal_dish_meal0_FK` (`id_meal`),
  CONSTRAINT `meal_dish_dish_FK` FOREIGN KEY (`id_dish`) REFERENCES `dish` (`id`),
  CONSTRAINT `meal_dish_meal0_FK` FOREIGN KEY (`id_meal`) REFERENCES `meal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `meal_dish`
--

LOCK TABLES `meal_dish` WRITE;
/*!40000 ALTER TABLE `meal_dish` DISABLE KEYS */;
INSERT INTO `meal_dish` VALUES (1,1),(10,1),(2,2),(2,3),(6,3),(12,3),(7,4),(18,4),(1,5),(4,5),(7,5),(16,5),(3,6),(8,7),(16,7),(19,8),(20,8),(7,9),(9,10),(15,10),(3,12),(7,12),(8,13),(14,13),(7,15),(18,15),(2,16),(3,16),(4,16),(11,16),(12,16),(1,17),(4,18),(15,18),(6,19),(8,19),(8,20),(9,20),(10,20),(11,20);
/*!40000 ALTER TABLE `meal_dish` ENABLE KEYS */;
UNLOCK TABLES;
